...
public final class Util {
     ...
     */
    public synchronized static boolean isDebugMode(final Context ctx, final String tag) {
        if (mEnableLog == null) {
            boolean debug = false;
            PackageInfo packageInfo = null;
            try {
                packageInfo = ctx.getPackageManager().getPackageInfo(ctx.getApplicationContext().getPackageName(),
    ...
    public static Bundle parseUrl(String url) {
        try {
            ...
            url = url.replace(uri.getScheme(), "http");
     ...
     */
    public static void logd(final Context ctx, final String tag, final String msg) {
